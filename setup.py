...
"""Setuptools based package definition for pytorch-experimentation"""
...
setuptools.setup(
    ...
    url="https://github.com/adam-scislowicz/pytorch_experimentation",
    license="proprietary and confidential",
    license_files=("LICENSE.txt",),
    description="environment for pytorch experimentation.",
    ...
    ext_modules=[CMakeExtension(name="pytorch_experimentation.cxxmod")],
